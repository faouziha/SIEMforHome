...
const Sidebar = () => {
  ...
  const menuItems = [
    { name: 'Dashboard', path: "/view/dashboard", icon: <LayoutDashboard size={20} /> },
    { name: 'Devices', path: "/view/devices", icon: <MonitorPlay size={20} /> },
    { name: 'Alerts', path: "/view/alerts", icon: <ShieldAlert size={20} /> },
    { name: 'Scans', path: "/view/scans", icon: <Terminal size={20} /> },
  ...
  return (
    <>
      ...
      >
        {isOpen ? <X className='text-green-400' size={24} /> : <Menu size={24} />}
      </button>
      ...
      `}>
        ...
        <div className="flex items-center gap-3 px-2 mb-10 mt-12 lg:mt-0">
          ...
          <span className="text-xl font-bold tracking-tighter text-white">DEVSEC</span>
        </div>
        ...
        <div className="mt-auto p-4 bg-cyber-gray/50 rounded-xl border border-gray-800/50 backdrop-blur-sm">
          <div className="flex justify-between items-center mb-2">
            <p className="text-[10px] text-gray-500 uppercase font-bold tracking-widest">System Load</p>
